...
class rewardShaper(Sofa.Core.Controller):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cartstem = self.rootNode.cartStem
    ...
    def getReward(self):
        ...
        current_pos = self._getTipsPos()
        dist = float(abs(current_pos[0]-self.goal[0]))
    ...
    def update(self):
        ...
        """
        current_pos = self._getTipsPos()
        self.init_goal_dist = float(abs(current_pos[0]-self.goal[0]))

    def _getTipsPos(self):
        pos = self.cartstem.MechanicalObject.position.value[-1,:3]
        return pos
...
def getState(rootNode):
    ...
    posCart = cartstem.cartStem.MechanicalObject.position.value.tolist()[0][0] #/factor
    posTip =  cartstem.cartStem.MechanicalObject.position.value.tolist()[-1][0] #/factor
...
class applyAction(Sofa.Core.Controller):
    ...
    def compute_action(self, actions, nb_step):
        ...
        current_position = self.cartstem.cartStem.MechanicalObject.position.value.tolist()[0][0]
