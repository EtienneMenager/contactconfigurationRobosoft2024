...
from sofagym.env.common.rpc_server import start_scene, get_infos
...
class BarManipulatorEnv(AbstractEnv):
    ...
    DEFAULT_CONFIG = {"scene": "BarManipulator",
                      ...
                      "save_data": False,
                      "save_image": False,
                      "save_path": path + "/Results" + "/BarManipulator",
                      "planning": False,
                      "discrete": False,
                      "seed": None,
...
register(
    id='barmanipulator-v0',
    entry_point='sofagym.env:BarManipulatorEnv',
)
